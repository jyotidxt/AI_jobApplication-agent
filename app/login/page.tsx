      ...
      <Card className="relative z-10 w-full max-w-md border-zinc-800/80 bg-zinc-900/40 backdrop-blur-xl shadow-2xl transition-all duration-300">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription className="text-zinc-400">
            Sign in to manage your AI job applications
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <Button
            ...
            disabled={loading}
            variant="outline"
            className="w-full h-11 border-zinc-800 bg-zinc-900/20 hover:bg-zinc-900/50 hover:text-white text-zinc-300 font-medium rounded-lg transition-colors flex items-center justify-center gap-3"
          >

...
export function ProfileForm({ initialProfile }: ProfileFormProps) {
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-12 items-start pb-12">
      {/* LEFT COLUMN: Profile Status & Tabs */}
      ...
      <form onSubmit={handleSave} className="lg:col-span-8 space-y-6">
        ...
        {activeTab === 'skills' && (
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    {skills.length === 0 ? (
                      <span className="text-xs text-zinc-605 text-zinc-500">No skills added yet.</span>
                    ) : (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    {certifications.length === 0 ? (
                      <span className="text-xs text-zinc-605 text-zinc-500">No certifications added yet.</span>
                    ) : (
            ...
            {/* Other details */}
            <div className="rounded-2xl border border-zinc-900 bg-zinc-950/40 p-6 md:p-8 space-y-4 shadow-xl backdrop-blur-xl animate-in fade-in duration-300">
              <h3 className="text-xl font-bold text-white flex items-center gap-2 border-b border-zinc-900 pb-3">
                <svg className="w-6 h-6 text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* Global form submission control at bottom of active panel */}
